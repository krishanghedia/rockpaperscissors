// pseudo-code for rock, paper, scissors DOM game
...
2. using OOP or procedural - 
    ...
    - when player the clicks, the computer should randomly pick their choice
        - (i believe the pure JS scipt for this is built)

    - wire up the findWinner function to a score board
